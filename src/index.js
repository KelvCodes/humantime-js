O string, t * @param {string} [locale='en'] - Language locale for formatting (default: tring} - Human-readable relative time.
 */
export function timeAgo(inputDate, locale = 'en') {
  ...
  // Difference in seconds (can be negative for future dates)
